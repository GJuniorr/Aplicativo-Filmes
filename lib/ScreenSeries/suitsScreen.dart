...
class suitsScreen extends StatefulWidget {
  const suitsScreen({super.key});

  @override
  State<suitsScreen> createState() => _suitsScreenState();
}

class _suitsScreenState extends State<suitsScreen> {
  @override
            ...
            child: Column(
              children: [
                ...
                const Padding(
                  ...
                  child: Text('Mesmo sem se formar e sem licença para advogar,\n um jovem impressiona um importante advogado\n e consegue uma cobiçada posição em sua firma.',
