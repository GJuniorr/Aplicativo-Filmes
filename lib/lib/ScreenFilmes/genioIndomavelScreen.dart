...
class genioIndomavelScreen extends StatefulWidget {
  const genioIndomavelScreen({super.key});

  @override
  State<genioIndomavelScreen> createState() => _genioIndomavelScreenState();
}

class _genioIndomavelScreenState extends State<genioIndomavelScreen> {
  @override
            ...
            child: Column(
              children: [
                ...
                const Padding(
                  ...
                  child: Text('Quando professores descobrem que\n um simples servente é um gênio da matemática\n, um terapeuta ajuda o jovem\n a confrontar os dêmonios\n que impedem seu desenvolvimento ',
