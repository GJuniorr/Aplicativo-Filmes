...
class vikingsScreen extends StatefulWidget {
  const vikingsScreen({super.key});

  @override
  State<vikingsScreen> createState() => _vikingsScreenState();
}

class _vikingsScreenState extends State<vikingsScreen> {
  @override
            ...
            child: Column(
              children: [
                ...
                const Padding(
                  ...
                  child: Text('A série acompanha a saga dos navegadores\n nórdicos que exploram  e conquistam\n novos territórios nos tempos medievais.',
