...
class blackMirrorScreen extends StatefulWidget {
  const blackMirrorScreen({super.key});

  @override
  State<blackMirrorScreen> createState() => _blackMirrorScreenState();
}

class _blackMirrorScreenState extends State<blackMirrorScreen> {
  @override
            ...
            child: Column(
              children: [
                ...
                const Padding(
                  ...
                  child: Text('Contos de ficção científica\n que refletem o lado negro das telas e da tecnologia,\n mostrando que nem toda novidade traz\n só benefícios.',
